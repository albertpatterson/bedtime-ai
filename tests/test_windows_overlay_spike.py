...
from src.bedtime_guard.ui.windows_overlay_spike import (
...
class WindowsOverlaySpikeTests(unittest.TestCase):
    ...
    def test_reactivation_controller_starts_timer_when_app_loses_activation(self) -> None:
        ...
        with patch("src.bedtime_guard.ui.windows_overlay_spike.QTimer", return_value=timer):
    ...
    def test_main_returns_error_when_no_screens_detected(self) -> None:
        with (
            patch("src.bedtime_guard.ui.windows_overlay_spike.QApplication") as app_class,
            patch("src.bedtime_guard.ui.windows_overlay_spike.build_windows", return_value=[]),
        ):
